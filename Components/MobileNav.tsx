...
const MobileNav = ({nav,closeNav}:props) => {
  ...
  return (
    <div className={`fixed ${navAnimation} transform transition-all duration-300 top-0 left-0 right-0 bottom-0
    z-[10000] bg-[#200f31]`}>
      <div className='w-[100vw] h-[100vh] flex flex-col items-center justify-center'>
        ...
        <a href='#' className='relative inline-flex items-center justify-center px-10 py-3
         overflow-hidden font-medium tracking-tighter text-white bg-gray-800 rounded-lg group'>
            <span className='absolute w-0 h-0 transition-all duration-500 ease bg-green-600 rounded-full
