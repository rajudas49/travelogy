...
const Hero = () => {
  return (
    <div className='relative w-[100%] h-[88vh]'>
      <video src='/images/hero.mp4' autoPlay muted loop preload='metadata'
      ...
      <div className='absolute z-[100] w-[100%] h-[100%] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
         <div className='flex items-center justify-center flex-col w-[100%] h-[100%]'>
           <div data-aos="fade-right">
             <h1 className='text-[25px] mb-[1rem] md:mb-[0] text-center md:text-[35px] lg:text-[45px] tracking-[0.7rem] text-white font-bold uppercase'>Lets Enjoys The Journey</h1>
           ...
           hover:ring-red-400 transition-all ease-out duration-300'>
            <span className='absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 translate-x-12 
